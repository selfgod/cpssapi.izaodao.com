...
module.exports = {
    ...
    plugins: [
        new webpack.DefinePlugin({
            JP_DOMAIN: JSON.stringify('http://d.jp.izaodao.com/'),
            MAIN_DOMAIN: JSON.stringify('http://d.izaodao.com/'),
            CPSS_DOMAIN: JSON.stringify('http://dcpss.jp.izaodao.com/'),
            ZD_KNOW: JSON.stringify('http://tknow.izaodao.com/')
        }),
        new webpack.optimize.CommonsChunkPlugin({
            // names: ['common', 'vendor'],
            name: 'common', // 将公共模块提取
            chunks: ['lc', 'tc', 'review', 'purchased', 'p_detail', 'zdtalk', 'unit_enter', 'unit_exam', 'unit_rest',
                'unit_review', 'unit_result', 'level_test', 'level_review', 'level_result', 'level_index',
                'level_generate','level_notice'], //提取哪些模块共有的部分
