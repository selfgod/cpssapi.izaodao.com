...
//DB配置
//zd_netschool数据库配置
defined('M_DB_HOST') OR define('M_DB_HOST', '192.168.1.202');
defined('M_DB_NAME') OR define('M_DB_NAME', 'zd_netschool');
defined('M_DB_USER') OR define('M_DB_USER', 'testdbh');
defined('M_DB_PWD') OR define('M_DB_PWD', '43Hzaodao197');
//zd_class数据库配置
defined('MINOR_DB_HOST') OR define('MINOR_DB_HOST', '192.168.1.202');
defined('MINOR_DB_NAME') OR define('MINOR_DB_NAME', 'zd_class');
defined('MINOR_DB_USER') OR define('MINOR_DB_USER', 'testdbh');
defined('MINOR_DB_PWD') OR define('MINOR_DB_PWD', '43Hzaodao197');
//zd_uc数据库配置
defined('MUC_DB_HOST') OR define('MUC_DB_HOST', '192.168.1.202');
defined('MUC_DB_NAME') OR define('MUC_DB_NAME', 'zd_uc');
defined('MUC_DB_USER') OR define('MUC_DB_USER', 'testdbh');
defined('MUC_DB_PWD') OR define('MUC_DB_PWD', '43Hzaodao197');
...
require_once PUBLIC_STATIC_DIR . 'config/development.php';
